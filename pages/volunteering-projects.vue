<template>
  <div>
    <Cover current="Volunteering Projects" image="" />
      ...
      <div class="row">
        <div class="col-12">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <a
                ...
                id="nav-human-trafficking-tab"
                data-toggle="tab"
                href="#nav-human-trafficking"
                role="tab"
          ...
          <div class="tab-content" id="nav-tabContent">
            <div
              class="tab-pane fade show active mt-5 pt-2"
              id="nav-human-trafficking"
              role="tabpanel"
              aria-labelledby="nav-human-trafficking-tab"
            >
              <!--  -->
